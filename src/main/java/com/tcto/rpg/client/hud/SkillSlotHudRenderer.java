...
public final class SkillSlotHudRenderer {
    ...
    public static void render(GuiGraphics guiGraphics) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            guiGraphics.blit(slotTexture, x, y, 0, 0, HudLayoutConfig.SKILL_SLOT_SIZE, HudLayoutConfig.SKILL_SLOT_SIZE, 256, 256);
            if (!skillId.isEmpty()) {
                ResourceLocation icon = skillIcon(skillId);
                guiGraphics.blit(icon, x + 2, y + 2, 0, 0, 16, 16, 256, 256);
            }
